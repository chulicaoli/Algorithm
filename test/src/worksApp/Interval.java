...
//		startTime = new String(start);
//		endTime = new String(end);
//	}
//}
public class Interval {
	/**
	...
	/**
	 * Get total time (minute) from "00:00" to terminal point of interval. For
	 * example, it returns 1440 when terminal point of interval is "24:00".
	 **/
